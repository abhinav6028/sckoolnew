      ...
      <section className="blog-single-section  py-5">
        <div className="admissionContainer">
          ...
          <div className="admissionFormContainer container">
            ...
            <section className="contact-section " style={{ marginTop: "75px" }} >
              <div className="container">
                <div className="contact-area">
                  <div className="row">
                    <div className="col-md-8 col-sm-12">
                      <div className="right-side">
                        ...
                        <div>
                          <p className="headercontainer" style={{ textAlign: "left", fontSize: "30px", color: "#2177aa", marginBottom: "50px" }}>ONLINE ADMISSION FORM</p>
                        </div>
                        <form >
                          <div className="row clearfix">
                            <div className="col-md-6 col-sm-12">
