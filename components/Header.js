              ...
              <div className={showNavbar} id="navbarSupportedContent">
                <ul className="navigation clearfix">
                  ...
                  <li
                    ...
                    onClick={handleNavBtn}
                  >
                    <Link href="/facilities" style={{ textDecoration: "none" }}>Facilities</Link>
                  </li>
                  <li
                    className={
                      router.pathname == "/management" ? "activeLink" : ""
                    ...
                    onClick={handleNavBtn}
                  >
                    <Link href="/management" style={{ textDecoration: "none" }}>Management</Link>
                  </li>
                  <li
                    className={
                      router.pathname == "/curriculum" ? "activeLink" : ""
                    ...
                    onClick={handleNavBtn}
                  >
                    <Link href="/curriculum" style={{ textDecoration: "none" }}>Curriculum</Link>
                  </li>
                  <li
                    className={
                      router.pathname == "/gallery" ? "activeLink" : ""
                  ...
                  <li
                    ...
                    onClick={handleNavBtn}
                  >
                    <Link href="/admission" style={{ textDecoration: "none" }}>Admission</Link>
                  </li>
                  <li
                    className={
                      router.pathname == "/contactus" ? "activeLink" : ""
                    ...
                    onClick={handleNavBtn}
                  >
                    <Link href="/contactus" style={{ textDecoration: "none" }}>Contact Us</Link>
                  </li>
                </ul>
              </div>
            </nav>
